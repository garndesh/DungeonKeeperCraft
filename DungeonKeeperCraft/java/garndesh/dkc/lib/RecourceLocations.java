...
public class RecourceLocations {
	...
	public static final ResourceLocation MINION_TEXTURE = new ResourceLocation(mod,texture+"model/MinionSkin.png");
	public static final ResourceLocation MINION_MODEL = new ResourceLocation(mod,model+"modelMinion.obj");
