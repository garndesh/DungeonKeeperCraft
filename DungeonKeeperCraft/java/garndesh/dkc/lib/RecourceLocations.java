...
public class RecourceLocations {
	...
	public static final ResourceLocation HEART_MODEL = new ResourceLocation(mod,model+"sphere.obj");
	public static final ResourceLocation HEART_TEXTURE = new ResourceLocation(mod,texture+"model/sphere.png");
